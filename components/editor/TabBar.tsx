...
export const TabBar = () => {
  ...
  return (
    <div className="fixed bottom-5 z-10 mx-auto flex w-full max-w-[370px] items-center justify-center gap-2 rounded-lg border border-none bg-gray-400/10 pt-3  backdrop-blur-[12px] sm:max-w-lg sm:px-10 dark:border-none dark:border-stone-300/20 dark:bg-gray-900/60">
